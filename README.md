# Fork of [DEAP](https://github.com/DEAP/deap) to replace Python random modules with Numpy random to keep consistent seed across Python 2 and 3 and benchmark Intel's Numpy (Development stage)
